...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Stratestic', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '生活各种策略分享', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://stratestic.chat', // 网站地址
